##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.7.1] date: [Sat Mar 07 20:53:21 EST 2020] 
##########################################################################################################################
...
# libraries
LIBS =  -lm -lnosys -lAWECore -larm_cortexM7l_math -larm_cortexM7lfdp_math -larm_cortexM7lfsp_math -lc
LIBDIR = -L"/Users/evan/mixr/software/mixr-firmware_rev1.4/libs"
LDFLAGS = $(MCU) -specs=nano.specs -specs=rdimon.specs -specs=nosys.specs -T$(LDSCRIPT) $(LIBDIR) $(LIBS) -Wl,-Map=$(BUILD_DIR)/$(TARGET).map,--cref -Wl,--gc-sections
